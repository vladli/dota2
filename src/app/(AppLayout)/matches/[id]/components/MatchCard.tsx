  ...
  return (
    <section className="flex flex-col items-center justify-around gap-4 py-10 lg:flex-row">
      <div className="hidden w-full flex-wrap items-center justify-center lg:flex lg:w-1/3">
        <Team team="Radiant" winner={victory} />
      </div>
      <div className="flex items-center justify-center gap-10 text-2xl font-semibold lg:w-1/3">
        <Score score={radiantScore} type="Radiant" victory={victory} />
        ...
        <Score score={direScore} type="Dire" victory={victory} />
      </div>
      <div className="hidden flex-col items-center font-medium lg:flex lg:w-1/3">
        <Team team="Dire" winner={victory} />
      </div>
    </section>
  );
}
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <h4
          className={cn(
            "w-fit rounded-large border border-divider bg-content1/50 px-2 py-1 text-sm",
            {
...
function Score({
  ...
  return (
    <div
      className={cn(
        "flex size-12 items-center justify-center rounded-large border border-divider bg-content1/50 p-2 text-foreground-600",
        {
